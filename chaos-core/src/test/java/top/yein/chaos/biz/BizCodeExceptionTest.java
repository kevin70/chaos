 ...
 */
class BizCodeExceptionTest {

  @Test
  void t1() {
    var e = new BizCodeException(BizCode.C0);
  ...
  void t2() {
    ...
    var e = new BizCodeException(BizCode.C0, message);
    assertThat(e.getBizCode()).isEqualTo(BizCode.C0);
  ...
  void t3() {
    ...
    var e = new BizCodeException(BizCode.C0, cause);
    assertThat(e.getBizCode()).isEqualTo(BizCode.C0);
  ...
  void t4() {
    var message = "custom message";
    var cause = new IllegalArgumentException();
    var e = new BizCodeException(BizCode.C0, message, cause);
    assertThat(e.getBizCode()).isEqualTo(BizCode.C0);
    assertThat(e.getRawMessage()).isEqualTo(message);
    assertThat(e.getCause()).isEqualTo(cause);
  }
  ...
  void t5() {
    var e =
      new BizCodeException(BizCode.C0)
  ...
  void t7() {
    ...
    var e =
      new BizCodeException(BizCode.C0, message)
        .addContextValue("label 1", "value 1")
        .addContextValue("label 2", "value 2")
